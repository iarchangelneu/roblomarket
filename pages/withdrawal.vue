        ...
        <div class="form">
            <div class="form__body">
                ...
                <div class="footer">
                    ...
                    <p class="mt-4" style="font-weight: 700;">3. Введите сумму, которую Вы хотите вывести на свой счет</p>
...
<script setup>
useSeoMeta({
    title: 'Вывод средств | RobloMarket',
    ogTitle: 'Вывод средств | RobloMarket',
    description: 'Вывод средств | RobloMarket',
    ogDescription: 'Вывод средств | RobloMarket',
})
</script>
