...
<script setup>
useSeoMeta({
    title: 'Неудачная транзакция | RobloMarket',
    ogTitle: 'Неудачная транзакция | RobloMarket',
    description: 'Неудачная транзакция | RobloMarket',
    ogDescription: 'Неудачная транзакция | RobloMarket',
})
</script>
